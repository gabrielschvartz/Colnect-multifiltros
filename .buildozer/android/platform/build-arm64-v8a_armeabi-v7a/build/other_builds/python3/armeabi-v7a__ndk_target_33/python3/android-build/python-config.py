#!/home/gabriel/colnect_proy/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/python3/armeabi-v7a__ndk_target_33/python3/android-build/android-root/bin/python3.14
# -*- python -*-
