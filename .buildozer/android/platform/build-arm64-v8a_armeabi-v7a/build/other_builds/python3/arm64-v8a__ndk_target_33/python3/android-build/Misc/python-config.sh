...
prefix="/home/gabriel/colnect_proy/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/python3/arm64-v8a__ndk_target_33/python3/android-build/android-root"
exec_prefix="${prefix}"
